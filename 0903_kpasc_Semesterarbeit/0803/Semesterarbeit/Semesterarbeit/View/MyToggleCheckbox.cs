...
{
    class MyToggleCheckbox : CheckBox
    {
        //Source Code: https://stackoverflow.com/questions/38431674/toggle-switch-control-in-windows-forms
        //but a little bit customized :-)

        public MyToggleCheckbox()
        {
